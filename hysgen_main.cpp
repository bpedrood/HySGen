...
int main(int argc, char* argv[]) {
  ...
  const TStr InFNm = Env.GetIfArgPrefixStr("-i:", "./Data/NSF/hypergraph.hyperedges", "Input [hyper]edgelist file url.");
  const TStr OutFPrx = Env.GetIfArgPrefixStr("-o:", "./nsf_res", "Output file url + name prefix for the discovered communities.");
  int OptComs = Env.GetIfArgPrefixInt("-c:", 309, "The number of communities to detect.");
